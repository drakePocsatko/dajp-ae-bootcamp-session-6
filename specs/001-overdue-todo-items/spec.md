...
- **FR-002**: System MUST display a clear visual overdue indicator for todos that are both incomplete and past due.
...
- **FR-005**: System MUST update overdue status when a todo is created, edited, or toggled complete/incomplete.
...
- **CA-004 Accessibility and UX**: Overdue indicators will remain keyboard-accessible context, maintain readable contrast in light and dark themes, and avoid replacing existing text semantics with color-only communication.
